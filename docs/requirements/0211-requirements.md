...
- 费用管理（Expenses）
  ...
  - 交易记录（Transactions，提供当前账号的交易信息：时间、交易额、原因、余额）
...
- 费用管理（Expenses）
  ...
  - 交易记录（Transactions，提供**当前账号的交易信息**：时间、交易额、原因、余额，和**和当前域有关（项目给域钱、域给云钱，管理费）的交易记录**：时间、支付人、接收人、费用、原因（管理费、项目资源收入、域资源支出））
  - 域计费（Domain）
...
- 费用管理（Expenses）
  ...
  - 交易记录（Transactions，提供**当前账号的交易信息**：时间、交易额、原因、余额，和**和当前项目有关（项目给域钱，管理费）的交易记录**：时间、支付人、接收人、费用、原因（管理费、项目资源支出）））
  - 项目计费（Project）
