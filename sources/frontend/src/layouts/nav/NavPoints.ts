...
export const availableNavPoints = [
  ...
  { path: "/expenses/systemTransactions", textId: root.expenses.systemTransactions },
  { path: "/expenses/domainTransactions", textId: root.expenses.domainTransactions },
  { path: "/expenses/projectTransactions", textId: root.expenses.projectTransactions },
